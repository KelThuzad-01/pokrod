...
Route11_Object:
	...
	object_event  1, 6, SPRITE_BOULDER, STAY, BOULDER_MOVEMENT_BYTE_2, TEXT_ROUTE11_DIGLETTSCAVE_SIGN
	object_event 1, 7, SPRITE_BOULDER, STAY, BOULDER_MOVEMENT_BYTE_2, TEXT_ROUTE11_DIGLETTSCAVE_SIGN
